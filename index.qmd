...
We'll do Problems 3,5,9,(12) in class today.  
...
First uncommit your commit with `git reset --hard HEAD^` or `git reset --hard HEAD~2`
...
-   In terminal: `git checkout branch-name` then
`git merge --no-ff -m "commit name" branch-name`
