...
[Lab 3](https://classroom.github.com/a/ypNBYwsR)
...
Let's consider how we view the coude. Maybe use `glimpse()` of `head()` instead of just typing `ne_county_health_2021`
...
The files for the project are on slack under the #project-1 channel

Your groups are listed there also.

The instructions for making a repo are there as well. 
