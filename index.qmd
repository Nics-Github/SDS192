...
[This class has a Slack channel](https://sds-192-ns-202401.slack.com). You should be able to log in with your Smith email. If you've got questions post them to Slack. I've introduced myself on Slack, your first assignment is to do that too.
...
-   Sign up for [github here](https://github.com/), if you don't already have an account.
