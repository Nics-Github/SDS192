...
Your API call will be return a dataframe with nothing in it, what does that mean?
...
In this last step make a final plot of your choosing, it can be a plot you made previously. Clean it up, don't use default colors, add context and give good titles and labels. Cite your source. Final apply a theme with theme_*() to lose the gray background. 
