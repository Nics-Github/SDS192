...
The winner was [Perpetual Plastic](https://perpetual-plastic.net/)
...
Go to the course GitHub organization and locate your assignment repo, which should be named `lab-01-plastic-waste-YOUR_GITHUB_USERNAME`.
...
Refer to [HW 01](./course-materials/hw-instructions/hw-01/hw-01-pet-names.html) if you would like to see step-by-step instructions for cloning a repo into an RStudio project.
...
I don't expect you to complete all of the exercises within the hour reserved for class.
Ideally, you should have got to this point.
If you still have some time left, move on to the remaining exercises below.
If not, you should find a time to meet with me and complete them outside of class.
