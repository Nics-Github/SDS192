...
#save(butterfly_location_data_8min, file = "eight_minute_data")
# 
load("eight_minute_data")
```
...
This map gives an interesting picture of where this type of citizen science is actually happening. I like the smaller icons, more than the larger butterflies, it feels misleading. Perhaps another icon representing how butterflies gather in trees would be more appropriate.

Change the big butterfly icon to a tree, I've included one, but if you can find one with a butterfly in it that would be nicer. Redraw your map.
