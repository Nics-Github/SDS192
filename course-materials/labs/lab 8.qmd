...
The id from the name table should match the person_id from the cast_info table. So we can join the name table with the cast_info. Notice that the names of the tables are being shorted again as n for name and ci for cast_info.
...
#. Find Annie MacDowell's full filmography, in chronological order. Include each movie's `title`, `production_year`, and the name of the character that she played. 
...
# Exercise: Get the name of every movie in the imdb databse that was produced on my birth year 1984. The response will be limited to 100, but there are more. 
...
# Exercise get the name of every movie that came out in 1984 that Annie MacDowell was in. Hint the answer is : Greystoke: The Legend of Tarzan, Lord of the Apes 
