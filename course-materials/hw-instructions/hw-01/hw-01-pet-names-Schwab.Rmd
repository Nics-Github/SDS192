...
This is the assignment that I completed.-Schwab  
...
-   are a member of the HCC's RStudio workbench server (which you are, just log on).
...
### Step 0. Make yourself a github Token.

-Log into Github.

-Click on the little image of yourself in the upper right and choose settings...

-On the left scroll down to developer settings

-Click Personal Access Tokens.

-Generate New Token. You might have to log in again

-I would generate a custom expiration of Dec 22,2022.

-Check all the boxes or "scopes" and generate token.

-Copy and Paste the token some place, you'll need it, think of it as a git password. Maybe a good word doc, or an email thread?
...
### Step 2. Go to HCC's RStudio Server

You are probably logged in here now, but just in case.

### Step 3. Clone the repo

In RStudio, click on **File \>New Project...** or the little R+ cube in the upper left. then choose **New Project from Git Repository**.

In the pop-up window, **paste the URL** you copied from GitHub.
...
```
The three most common names are Lucy, Charlie, and Luna.
...
This feels a little silly to arrange by species first, the result is basically the same. 
...
The ones below the line are more common for cats than dogs. 
It looks roughly positive, this means that the cats and dogs have names in common. 