---
title: "hw-06-Scraping-Startrek-TNG"
author: "Schwab"
format: html
editor: visual
---

This is the code from the example in on Day 20. 
...
#This will separate the first_aired and put them back together without the extra dates. 

Star_Trek_Air_Dates <- Star_Trek_Air_Dates %>%
  separate(col = first_aired, into = c("month","day","year") ) |> 
  unite(col = "first_aired", c("month","day","year"))
  
#This will separate the last_aired column and put them back together without the extra dates. 
