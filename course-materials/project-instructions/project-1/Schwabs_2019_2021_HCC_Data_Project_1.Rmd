...
```{r look}
head(HCC_DATA_19_21, echo=FALSE, eval=FALSE)
```
...
HCC_DATA_19_21 |>
  filter(MA_TOWN_GRP == c("Springfield","Holyoke","Chicopee","West Springfield", "Westfield")) |>
  ggplot(aes(x = MA_TOWN_GRP))+
  geom_bar()+
  facet_grid(~TERM)+
